...
try {
    ...
    if (isset($_POST["create"])) {
        session_start();
        $professorWhose      = $_SESSION['accountnumber'];
        $select              = $_POST["select"];
        $course_id           = $_POST["course_id"];
        $pgSelect = "SELECT * from big_database WHERE 
            semester = '" . $select . "' AND course_id = '" . $course_id . "' AND professor_id = '" . $professorWhose . "'";
    }
...
<body>
    <div class="container" id="container1">
        <div class="container" id="container2">
            <!-- <form action="create_course_score.php" method="post">
                <p>請輸入學生的成績</p>
                <p>輸入課程類別、課程名稱及該課的教授名字~~</p>
                <select name="select">
                ...
                <p><input type="text" id="course_id" name="course_id" placeholder="course_id"></p>
                <p><input type="submit" id="create" name="create" value="create"></p>
                <p><input type="button" id="show" name="show" value="show" onclick="Show()"></p>
                <p><input type="button" id="print" name="print" value="print" onclick="Print(print_parts)"></p>
                <p><input type="button" id="back" name="back" value="back" onclick="Back()"></p>
            </form> -->
            <form action="create_course_score.php" method="post">
                <div class="form-group">
                    <label for="student_grade">請輸入課程代碼</label>
                    <select name="select">
                        <option value="1081">108 上學期</option>
                        <option value="1082">108 下學期</option>
                        <option value="1091">109 上學期</option>
                    ...
                    <input type="text" class="form-control" id="course_id" name="course_id" placeholder="課程代碼">
                    <P></P>
                    <input type="submit" class="btn btn-primary" id="create" name="create" value="確定">

                    <input type="button" class="btn btn-primary" id="show" name="show" value="顯示" onclick="Show()">

                    <input type="button" class="btn btn-primary" id="print" name="print" value="印成績單" onclick="Print(print_parts)">

                    <input class="btn btn-primary" type="button" id="back" name="back" value="返回" onclick="Back()">
                </div>
            </form>
            <div id="print_parts">
