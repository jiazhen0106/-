...
try {
    ...
    if (isset($_POST["insert"])) {
        ...
        if($accountnumber!=""&&$password!=""&&$id!=""&&$name!=""){
            $insert = "INSERT INTO account(accountnumber, password, id, name) VALUES
                        ('" . $accountnumber . "', '" . $password . "', '" . $id . "', '" . $name . "')";
    ...
    <div class="container" id="container1">
        <div class="container" id="container2">
            <!-- <form action="account_insert.php" method="post">
                ...
                <p><input type="submit" id="insert" name="insert" value="insert"></p>
            ...
            <form action="account_insert.php" method="post">
                ...
                <p><input class="btn btn-primary" type="submit" id="insert" name="insert" value="新增">
