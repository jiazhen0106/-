...
<body>
    <div class="container" id="container1">
        <div class="container" id="container2">
            <form action="student_check _score.php" method="post">
                <h2>請選擇要查看成績的學期</h2>
                <select name="select">
                ...
                <p></p>
                <p><input class="btn btn-primary" type="submit" id="check" name="check" value="確定"></p>
                <input class="btn btn-primary" type="button" id="show" name="show" value="顯示" onclick="Show()">
