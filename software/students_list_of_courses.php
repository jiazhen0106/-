...
<body>
    <div class="container" id="container1">
        <div class="container" id="container2">
            ...
            <p>
                ...
                <input type="text" name="search_course_id" id="search_course_id" placeholder="課程代碼">
    ...
    <script>
        ...
        function show_semester_and_course_id(c) {
            $.each(c, function(key, value) {
                if (value.semester == $("#search_semester").val() && value.course_id == $("#search_course_id").val()) {
                    $("#student_course tbody").append(
                        "<tr>" +
                        "<td>" + value.semester + "</td>" +
                        "<td>" + value.course_id + "</td>" +
        ...
        $(function(){
            ...
            $('#search').on('click', function() {
                ...
                var search_course_id = $("#search_course_id").val();
                $.ajax({
                    url: "student_course_list.php",
                    type: "GET",
                    dataType: "json",
                    success: function(abc) {
                        clean();
                        show_semester_and_course_id(abc)
                        if (search_course_id == "") {
                            show(abc)
                        }
                    },
