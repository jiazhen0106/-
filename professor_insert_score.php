...
try {
    ...
    $pgSelect = "SELECT * from big_database WHERE semester='1091'  AND professor_id = '" . $professorWhose . "'";
    ...
    if (isset($_POST["insert"])) {
        ...
        $score                  = $_POST["score"];
        $semester               = "1091";
        if ($course_id!=""&&$student_id!=""&&$score!=""){
            $update = "UPDATE big_database SET score = $score 
                WHERE course_id = '" . $course_id . "' AND student_id = '" . $student_id . "' AND professor_id = '" . $professorWhose . "'AND semester='" . $semester . "'";
...
<body>
    <div class="container" id="container1">
        <div class="container" id="container2">
            <form action="professor_insert_score.php" method="post">
                <h2>請輸入學生的成績</h2>
                <h4>輸入課程代碼、學生學號及想給學生的分數~~109_1</h4>
                ...
                <p><input type="submit" class="btn btn-primary" id="insert" name="insert" value="確定">
            ...
            <!-- <input type="button" class="btn btn-primary" id="print" name="print" value="print" onclick="Print(print_parts)"> -->
